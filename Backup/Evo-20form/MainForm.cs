...
namespace Evo_20form
{
    public partial class MainForm : Form
    {
        ...
        private void EvoConnectionChangeHandler(Utils.ConnectionStatus state)
        {
        ...
        {
            controllerWokModeLabel.Invoke(new Action(() => { controllerWokModeLabel.Text = mode.ToView(); }));
        }
